...
const CreateOfficeForm = () => {
	...
	return (
		<>
			<div className="rounded-2xl px-6 border border-green-400 max-w-5xl overflow-x-hidden">
				{/* FORM HEADING  */}
				<div className="">
            ...
            */}
						...
						<div className="flex flex-end">
							...
							<button
								type="submit"
								className=" bg-[#002147] py-3 px-4 capitalize font-medium text-sm gap-2 rounded-lg text-white"
							>
								Create
							</button>
						</div>
